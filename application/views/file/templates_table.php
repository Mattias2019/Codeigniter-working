    ...
    if (isset($this->outputData['files']) && count($this->outputData['files']) > 0) {
        ...
        foreach ($this->outputData['files'] as $file) { ?>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo site_url('file/index/2?id=' . $file['id']); ?>" class="file-action">
                        <span class="file-action-img"><?php echo svg('other/edit', TRUE) ?></span>
                        <span><?= t('Edit'); ?></span>
                    </a>
                    <a href="<?php echo site_url('file/index/2?id=' . $file['id'] . '&action=copy'); ?>"
                       class="file-action">
                        <span class="file-action-img"><?php echo svg('other/move', TRUE) ?></span>
                        <span><?= t('Copy'); ?></span>
                    </a>
                    <a href="<?php echo site_url('file/delete/2?id=' . $file['id']); ?>"
