    ...
    <div class="clsInnerCommon">
        ...
        <div class="col-xs-12">
            ...
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject font-dark bold uppercase"><?= t('Project Details'); ?></span>
                </div>
            </div>
            ...
            <div class="col-xs-12">
                <div class="row form-group">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <a href="<?=site_url('project/close?id='.$project['id'])?>" class="button big primary<?php if (!($project['creator_id'] == $this->logged_in_user->id and $project['job_status'] == Project_model::PROJECT_STATUS_ACTIVE and count($cases) == 0)) echo ' disabled'; ?>"><?= t('Close Project'); ?></a>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <a href="<?=site_url(count($cases) == 0?'cancel/create?id='.$project['id']:'cancel/index/'.$cases[0]['id'])?>" class="button big primary<?php if (!($project['job_status'] == Project_model::PROJECT_STATUS_ACTIVE)) echo ' disabled'; ?>"><?= t(count($cases) == 0?'Open Case':'View Case'); ?></a>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <a href="<?=site_url('project/invoice?project='.$project['id'])?>" class="button big primary<?php if (!($project['employee_id'] == $this->logged_in_user->id and $project['job_status'] == Project_model::PROJECT_STATUS_ACTIVE and count($invoices) == 0)) echo ' disabled'; ?>"><?= t('Send Invoice'); ?></a>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <a href="<?=site_url('project/review?id='.$project['id'])?>" class="button big primary<?php if (!in_array($project['job_status'], [Project_model::PROJECT_STATUS_COMPLETED, Project_model::PROJECT_STATUS_CANCELED]) or $payment_due > 0 or count($reviews) > 0) echo ' disabled'; ?>"><?= t('Review Project'); ?></a>
                    </div>
                </div>
            </div>
