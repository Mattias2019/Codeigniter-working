...
//$config['base_url']	= "https://consult24online.com/";
$config['base_url'] = ((array_key_exists('SERVER_PORT', $_SERVER) and $_SERVER['SERVER_PORT'] == 443) ? 'https' : 'http') . "://localhost:10088";
...
//$config['db_username'] = "web427";
//$config['db_password'] = "Xm35dELf";
//$config['db'] = "usr_web427_2";
...
$config['max_portfolio_attachments'] = 2;
...
$config['admin_controllers_folder'] 	= 'administration'; //No trailing slash
